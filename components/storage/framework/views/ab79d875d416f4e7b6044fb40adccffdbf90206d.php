...
} elseif ($_instance->childHasBeenRendered('fgG0x0O')) {
    $componentId = $_instance->getRenderedChildComponentId('fgG0x0O');
    $componentTag = $_instance->getRenderedChildComponentTagName('fgG0x0O');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fgG0x0O');
} else {
    $response = \Livewire\Livewire::mount('admin.settings.general');
    $html = $response->html();
    $_instance->logRenderedChild('fgG0x0O', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\asif\components\resources\views/admin/general.blade.php ENDPATH**/ ?>
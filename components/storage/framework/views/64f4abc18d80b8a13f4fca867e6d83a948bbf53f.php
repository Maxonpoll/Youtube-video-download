...
<!-- Theme JS -->
<script src="<?php echo e(asset('assets/js/main-dashboard.min.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\asif\components\resources\views/components/admin/footerAssets.blade.php ENDPATH**/ ?>
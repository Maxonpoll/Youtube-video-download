...
<?php endif; ?>
    ...
    <!-- Nestable -->
    <script src="<?php echo e(asset('assets/js/jquery.nestable.min.js')); ?>"></script>

    <link type="text/css" href="<?php echo e(asset('assets/css/jquery.nestable.min.css')); ?>" rel="stylesheet">
...
<?php endif; ?>
          ...
          <!-- End Navbar -->
            ...
            <div class="container-fluid py-4">
               ...
               <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.settings.menu')->html();
} elseif ($_instance->childHasBeenRendered('POyLj8Y')) {
    $componentId = $_instance->getRenderedChildComponentId('POyLj8Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('POyLj8Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('POyLj8Y');
} else {
    $response = \Livewire\Livewire::mount('admin.settings.menu');
    $html = $response->html();
    $_instance->logRenderedChild('POyLj8Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\asif\components\resources\views/admin/menu.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('JHfvW4P')) {
    $componentId = $_instance->getRenderedChildComponentId('JHfvW4P');
    $componentTag = $_instance->getRenderedChildComponentTagName('JHfvW4P');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JHfvW4P');
} else {
    $response = \Livewire\Livewire::mount('admin.dashboard');
    $html = $response->html();
    $_instance->logRenderedChild('JHfvW4P', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\y2load\components\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
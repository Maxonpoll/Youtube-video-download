<div class="d-flex" wire:ignore.self>
	<div class="col-auto">
		<form wire:submit.prevent="onUpdateAvatar">
			<div class="avatar avatar-xl position-relative">
				<img src="<?php echo e($profile->avatar); ?>" alt="<?php echo e(__('Avatar')); ?>" class="w-100 border-radius-lg shadow-sm">
				...
				<a href="javascript:;" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2 edit-avatar" data-input="avatar">
					<i class="fa fa-pen top-0" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Edit Image')); ?>"></i>
				</a>
	...
	<div class="col-auto my-auto ps-4">
		<div class="h-100">
			<h5 class="mb-1"><?php echo e($profile->fullname); ?></h5>
			...
			<ul class="nav nav-pills nav-fill p-1" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link mb-0 px-0 py-1" href="javascript:;" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile">
						...
						<span class="ms-1"><?php echo e(__('Update Profile')); ?></span>
					</a>
				</li>
				...
				<li class="nav-item">
					<a class="nav-link mb-0 px-0 py-1" href="javascript:;" id="password-tab" data-bs-toggle="tab" data-bs-target="#password">
						...
						<span class="ms-1"><?php echo e(__('Change Password')); ?></span>
					</a>
				</li>
...
</div><?php /**PATH C:\xampp\htdocs\asif\components\resources\views/livewire/admin/profile/avatar.blade.php ENDPATH**/ ?>
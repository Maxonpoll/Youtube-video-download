          ...
          <!-- End Navbar -->
            ...
            <div class="container-fluid py-4">
                <div class="row">
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.settings.advanced')->html();
} elseif ($_instance->childHasBeenRendered('EwEPx3u')) {
    $componentId = $_instance->getRenderedChildComponentId('EwEPx3u');
    $componentTag = $_instance->getRenderedChildComponentTagName('EwEPx3u');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EwEPx3u');
} else {
    $response = \Livewire\Livewire::mount('admin.settings.advanced');
    $html = $response->html();
    $_instance->logRenderedChild('EwEPx3u', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\asif\components\resources\views/admin/advanced.blade.php ENDPATH**/ ?>
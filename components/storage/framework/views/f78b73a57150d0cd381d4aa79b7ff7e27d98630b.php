...
} elseif ($_instance->childHasBeenRendered('PFmRcF8')) {
    $componentId = $_instance->getRenderedChildComponentId('PFmRcF8');
    $componentTag = $_instance->getRenderedChildComponentTagName('PFmRcF8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PFmRcF8');
} else {
    $response = \Livewire\Livewire::mount('frontend.report');
    $html = $response->html();
    $_instance->logRenderedChild('PFmRcF8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <?php break; ?>
...
} elseif ($_instance->childHasBeenRendered('NeSwW51')) {
    $componentId = $_instance->getRenderedChildComponentId('NeSwW51');
    $componentTag = $_instance->getRenderedChildComponentTagName('NeSwW51');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NeSwW51');
} else {
    $response = \Livewire\Livewire::mount('frontend.contact');
    $html = $response->html();
    $_instance->logRenderedChild('NeSwW51', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <?php break; ?>
...
<?php /**PATH C:\xampp\htdocs\asif\components\resources\views/livewire/frontend/pages.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
    ...
    <form wire:submit.prevent="onEditProxy(<?php echo e($this->proxy_id); ?>)">
        <div class="form-group">
            <label for="name" class="form-control-label"><?php echo e(__('IP Address')); ?></label>
            <input class="form-control" type="text" wire:model="ip">
        </div>

        <div class="form-group">
            <label for="name" class="form-control-label"><?php echo e(__('Port')); ?></label>
            <input class="form-control" type="text" wire:model="port">
        </div>

        <div class="form-group">
            <label for="name" class="form-control-label"><?php echo e(__('Type')); ?></label>
        ...
        <div class="form-group">
            <label for="name" class="form-control-label"><?php echo e(__('Username')); ?></label>
            <input class="form-control" type="text" wire:model="username">
        </div>

        <div class="form-group">
            <label for="name" class="form-control-label"><?php echo e(__('Password')); ?></label>
...
</div><?php /**PATH C:\xampp\htdocs\laravel\y2load\components\resources\views/livewire/admin/proxy/edit.blade.php ENDPATH**/ ?>
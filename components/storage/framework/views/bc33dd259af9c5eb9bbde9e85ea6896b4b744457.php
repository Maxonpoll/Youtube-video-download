          ...
          <div class="container-fluid py-4">
            <div class="row">
                <div class="col">
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.settings.header')->html();
} elseif ($_instance->childHasBeenRendered('XH6mgwX')) {
    $componentId = $_instance->getRenderedChildComponentId('XH6mgwX');
    $componentTag = $_instance->getRenderedChildComponentTagName('XH6mgwX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XH6mgwX');
} else {
    $response = \Livewire\Livewire::mount('admin.settings.header');
    $html = $response->html();
    $_instance->logRenderedChild('XH6mgwX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\asif\components\resources\views/admin/header.blade.php ENDPATH**/ ?>
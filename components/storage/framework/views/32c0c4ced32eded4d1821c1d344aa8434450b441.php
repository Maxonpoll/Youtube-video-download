          ...
          <!-- End Navbar -->
            ...
            <div class="container-fluid py-4">
                <div class="row">
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.settings.gdpr')->html();
} elseif ($_instance->childHasBeenRendered('R3dGEly')) {
    $componentId = $_instance->getRenderedChildComponentId('R3dGEly');
    $componentTag = $_instance->getRenderedChildComponentTagName('R3dGEly');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('R3dGEly');
} else {
    $response = \Livewire\Livewire::mount('admin.settings.gdpr');
    $html = $response->html();
    $_instance->logRenderedChild('R3dGEly', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\asif\components\resources\views/admin/gdpr.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>" type="text" wire:model="slug" id="slug" required>
		...
		<div class="form-group">
			<label for="type" class="form-label"><?php echo e(__('Page Type')); ?></label>
		...
		<div class="form-group">
			<label for="featured-image" class="form-label"><?php echo e(__('Featured image')); ?></label>
			<div class="input-group">
...
<?php /**PATH C:\xampp\htdocs\asif\components\resources\views/livewire/admin/pages/create.blade.php ENDPATH**/ ?>
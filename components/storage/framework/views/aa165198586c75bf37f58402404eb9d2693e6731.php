...
<?php endif; ?>
          ...
          <!-- End Navbar -->
            ...
            <div class="container-fluid py-4">
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.settings.advertisement')->html();
} elseif ($_instance->childHasBeenRendered('Lg5QOw0')) {
    $componentId = $_instance->getRenderedChildComponentId('Lg5QOw0');
    $componentTag = $_instance->getRenderedChildComponentTagName('Lg5QOw0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Lg5QOw0');
} else {
    $response = \Livewire\Livewire::mount('admin.settings.advertisement');
    $html = $response->html();
    $_instance->logRenderedChild('Lg5QOw0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\asif\components\resources\views/admin/advertisement.blade.php ENDPATH**/ ?>
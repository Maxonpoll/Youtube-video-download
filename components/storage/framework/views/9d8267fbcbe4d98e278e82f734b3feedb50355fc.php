...
<?php endif; ?>
    ...
    <form wire:submit.prevent="onAddProxy">
        ...
        <div class="form-group">
            <label for="name" class="form-control-label"><?php echo e(__('Enter the Proxy list in the format:')); ?> <code><?php echo e(__('ip:port:user:pass')); ?></code> <?php echo e(__('or')); ?> <code><?php echo e(__('ip:port')); ?></code></label>
...
<?php /**PATH C:\xampp\htdocs\laravel\y2load\components\resources\views/livewire/admin/proxy/create.blade.php ENDPATH**/ ?>
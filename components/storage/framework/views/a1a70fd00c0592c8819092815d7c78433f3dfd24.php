...
<?php endif; ?>
          ...
          <!-- End Navbar -->
            ...
            <div class="container-fluid py-4">
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.settings.general')->html();
} elseif ($_instance->childHasBeenRendered('vDWsU0B')) {
    $componentId = $_instance->getRenderedChildComponentId('vDWsU0B');
    $componentTag = $_instance->getRenderedChildComponentTagName('vDWsU0B');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vDWsU0B');
} else {
    $response = \Livewire\Livewire::mount('admin.settings.general');
    $html = $response->html();
    $_instance->logRenderedChild('vDWsU0B', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\y2load\components\resources\views/admin/general.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('7GywAG5')) {
    $componentId = $_instance->getRenderedChildComponentId('7GywAG5');
    $componentTag = $_instance->getRenderedChildComponentTagName('7GywAG5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7GywAG5');
} else {
    $response = \Livewire\Livewire::mount('frontend.maintenance');
    $html = $response->html();
    $_instance->logRenderedChild('7GywAG5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('uWwQqjt')) {
    $componentId = $_instance->getRenderedChildComponentId('uWwQqjt');
    $componentTag = $_instance->getRenderedChildComponentTagName('uWwQqjt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uWwQqjt');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('uWwQqjt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\asif\components\resources\views/frontend/pages.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('EuHBZgu')) {
    $componentId = $_instance->getRenderedChildComponentId('EuHBZgu');
    $componentTag = $_instance->getRenderedChildComponentTagName('EuHBZgu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EuHBZgu');
} else {
    $response = \Livewire\Livewire::mount('admin.settings.api-keys');
    $html = $response->html();
    $_instance->logRenderedChild('EuHBZgu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\y2load\components\resources\views/admin/api-keys.blade.php ENDPATH**/ ?>
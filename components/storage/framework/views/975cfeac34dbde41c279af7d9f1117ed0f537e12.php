...
<link rel="stylesheet" href="<?php echo e(asset('assets/css/fontawesome.min.css')); ?>">
 ...
 <!-- Theme CSS -->
<link type="text/css" href="<?php echo e(asset('assets/css/main-dashboard.min.css')); ?>" rel="stylesheet">
...
<!-- jQuery -->
<script src="<?php echo e(asset('assets/js/jquery.min.js')); ?>"></script>   <?php /**PATH C:\xampp\htdocs\laravel\y2load\components\resources\views/components/admin/headerAssets.blade.php ENDPATH**/ ?>
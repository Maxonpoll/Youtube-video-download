<div>
	...
	<form wire:submit.prevent="onUpdateAPIKeys" class="row">
		...
		<div class="col-12 mb-4">
			<div class="card">
				<div class="card-body">
					<h6>{{ __('reCAPTCHA v3') }} (<a href="https://y2load.com/" target="_blank" class="text-gradient text-primary">{{ __('How to get Google reCAPTCHA v3 Keys') }}</a>)</h6>
					<hr>
...
{{-- 		<div class="col-12 mb-4">
			<div class="card">
				<div class="card-body">
					<h6>{{ __('Twitter') }} (<a href="https://y2load.com" target="_blank" class="text-gradient text-primary">{{ __('How to get API Keys and Access Tokens for Twitter') }}</a>)</h6>
					<hr>
					<table class="table settings">
						<tr>
		...
		<div class="col-12 mb-4">
			<div class="card">
				<div class="card-body">
					<h6>{{ __('Facebook') }} (<a href="https://y2load.com" target="_blank" class="text-gradient text-primary">{{ __('How to get Facebook Cookies') }}</a>)</h6>
					<hr>
					<table class="table settings">
						<tr>
		...
		<div class="col-12 mb-4">
			<div class="card">
				<div class="card-body">
					<h6>{{ __('Instagram') }} (<a href="https://y2load.com" target="_blank" class="text-gradient text-primary">{{ __('How to get Instagram Cookies') }}</a>)</h6>
					<hr>
					<table class="table settings">
						<tr>

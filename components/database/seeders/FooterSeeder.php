          ...
          foreach ($footers as $footer) {
              ...
              foreach ($footer->translations as $footerTran) {
                   ...
                   FooterTranslation::create([
                      ...
                      "layout"      => 5,
                      "widget1"     => '<h6 class="text-gradient text-primary font-weight-bolder">About Us</h6> <p>Y2load YouTube Downloader is a leading downloader that focuses on free HD High Quality video services. You can find massive amount of video & music, and also download content from various websites, including but not limited to Youtube, Facebook, Instagram , Twitter, Vlive, Tiktok, Soundcloud, Vimeo. Easy, fast, and small, Y2load YouTube Downloader is your best choice for video download.</p>',
                      ...
                      "bottom_text" => '<p>Copyrights © %year%. All Rights Reserved by <a title="Y2load" href="https://y2load.com/" target="_blank" rel="noopener">Y2load</a>.</p>',
                      "footer_id"   => $footer->id
                  ]);
